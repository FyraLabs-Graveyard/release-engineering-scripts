...
for package in pkgs:
    ...
    try:
        git = pygit2.clone_repository(pkg_repo['http_url_to_repo'], os.path.join(workdir, pkgname))
    ...
    try:
        ...
        if 'authentication required' in str(e):
            logger.error(f'Authentication error for {pkgname}. Please set up authentication. This script will now clean up and exit.')
